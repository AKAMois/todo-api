...
const port = 3000; // Añadimos el puerto en una variable
const urlMongoAtlas = "mongodb+srv://god:godgodgod@taskdb.p9glwvt.mongodb.net/?retryWrites=true&w=majority&appName=taskdb"; // URL de conexión a MongoDB Atlas
...
async function startServer() {
  try {
    ...
    app.listen(port, () => {
      console.log('Servidor levantado'); // Confirmamos que el servidor está corriendo
    });
